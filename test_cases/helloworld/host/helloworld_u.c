...
oe_result_t helloworld_enclave_helloworld(oe_enclave_t* enclave)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _helloworld_ecall_info_table[helloworld_fcn_id_enclave_helloworld].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(helloworld_enclave_helloworld, enclave_helloworld);
